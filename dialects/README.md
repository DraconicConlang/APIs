...
Main:
- **Licensing**: <u>License your dialect the same as Classic Draconic.</u> The Draconic Language is licensed under [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/), so you need to license your dialect the same and state original author (human1011).
- **Naming**: <u>Get a unique and not too broad or overused name for your dialect.</u> Names like "Medieval Draconic" most probably wont be accepted, same goes with memes, brain rot, and other things kids have these days. Example Draconic is already used as an example for people on how to code your own dialect. If you really want, you can drop the "Draconic" part, but that depends if its still reasonably understandable.
- **Abbreviation**: <u>Abbreviated form of the dialects should be unique as well.</u> Abbreviation should consist of "dr_" as a language family, and your dialect's name (2 letters). Classic Draconic has abbreviated form "dr_dr" because it's the starting point of the language.

Code:
- **Branches**: <u>Work in separate branches instead of the main one.</u> When you are done updating and testing everything, you may create a pull request. Please respect other's boundaries, don't edit other's dialects in any way.  Classic Draconic is maintained by Liirios, _eXeCutie and SuPDuZz.
- **Consistency**: <u>Stick to Classic Draconic's code structure.</u> Some developers may not want to struggle to integrate your dialect into their projects. Avoid changing names or structures arbitrarily, unless Classic ones are changed.
- **Deprecation**: <u>Put your removed functions in deprecated module.</u> If you remove or replace functions or mappings, mark them as deprecated in the original JS and include them in Deprecated.js to maintain compatibility. You may leave them as-is without updates. If they cannot work under any circumstances, you may delete them.
- **Security**: <u>Do not make any kind of malware.</u> The system executes any JavaScript code you put in it, so for security reasons, hosting the dialect outside this repository is prohibited (it won't be listed here as public, you would need to use custom link to load the dialect, which is not the best idea again due to security reasons), and every pull requests will be reviewed for malware and such by me or my project team.
- **Dependencies**: <u>Do not rely on external modules/libraries.</u> Outside dependencies may again be a security concern and may increase load time.
- **Revisions**: <u>Don't farm revisions.</u> To not allow revision farming, you may only increment revisions upon reasonable amount of changes in the dialect, see Classic Draconic updates' changes. Code changes aside changing the end result (like adding new rules, letters or affixes) aren't considered as revisions.

Niece things:
- **AI and LLMs**: <u>AI assistance is prohibited.</u> Any dialects created with AI or LLM assistance will not be regarded as legitimate by me and my project team, and I will claim the right to refute access to host the dialect publicly through the APIs for any such case, given it surpasses a level of severity I myself will be the judge of. AI or LLM assistance includes AI generated artwork (the amount of AI art is already sickening), music, text (phrases, words, definitions, etc.), or other assets.
- **Forbidden content**: We wont accept dialects containing someone's personal information, NSFW/Gore/Fetish/Sexualized content, illegal topics or any way of harassment/bullying/shaming other people, communities or minorities. Lets keep it neutral and safe. 
- **Forbidden maintainers**: We wont accept dialects made or maintained by horrible people, this includes: hackers, scammers, predators, nazis, pedophiles, zoophiles (especially from the furry community), you name it.
...
**ID** is abbreviaited form of the dialect.
